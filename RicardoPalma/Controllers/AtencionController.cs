                        ...
                        reporte = resultado.Select(g => new BEReporteAtencionEmergencia()
                             {
                                 ...
                                 Eliminar = "<button type='button' id='btnEliminarAtencion' onclick='EliminarAtencionEmergencia(" + g.IdTicketEmergencia + ");' class='btn btn-primary btn-xs' >Eliminar</button>",
